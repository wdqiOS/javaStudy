...
public class ArrayDemo3 {
	public static void main(String[] args) {
		...
		// 为第2行第3列的元素赋值为9
		intArray[1][2] = 9;
		System.out.println("intArray数组的2行第3列的元素为："+intArray[1][2]);
		
		// 声明数组的同时进行创建
		char[][] ch = new char[3][5];
		// 创建float类型的数组时，只指定行数
		floatArray = new float[3][];
//		System.out.println(floatArray[0][0]); // 空指针错误❌
		// 每行相当于一个一维数组，需要创建
...
//		System.out.println(floatArray[0][4]);  // 数组下标越界❌
